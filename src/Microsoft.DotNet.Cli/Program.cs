...
Common Commands:
  ...
  pack          Creates a NuGet package";
        ...
        private static bool IsArg(string candidate, string shortName, string longName = null)
        {
            return candidate.Equals("-" + shortName) || (longName != null && candidate.Equals("--" + longName));
        }
    }
}
